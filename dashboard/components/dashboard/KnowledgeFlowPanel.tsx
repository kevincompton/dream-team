...
export function KnowledgeFlowPanel({ requests, flowCounts }: KnowledgeFlowPanelProps) {
  ...
  return (
    <div className="grid h-full grid-rows-[1fr_1fr] gap-4">
      <Panel title="Knowledge Flow" className="min-h-[360px]">
          ...
          <AnimatePresence>
            {requests.slice(0, 5).map((request) => (
              ...
              >
                ...
                <span className="truncate text-hive-text">{request.question}</span>
